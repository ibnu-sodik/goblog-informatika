...
class Komentar extends CI_Controller {
	...
	{		
		...
		if ($this->form_validation->run() === FALSE) {
			...
			$id_komentar_artikel 	= $this->input->post('id_komar_blas', TRUE);
			...
			$daper 			= $this->personil_model->get_data_by_id($id_personil)->row();
			$nama_komentar 	= $daper->full_name;
			$email_komentar = $daper->email;

			$this->komentar_model->balas($id_komentar, $nama_komentar, $email_komentar, $id_komentar_artikel, $id_author, $website_komentar, $konten_komentar);
	...
	{		
		...
		$id_personil = $this->session->userdata('id');
		$query = $this->db->get_where('tb_komentar', array('id_author_artikel' => $id_personil));
		...
		$data['komentar'] 	= $this->komentar_model->get_all_komentar($offset, $limit, $id_personil);
