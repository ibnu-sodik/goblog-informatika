						...
						<?php if($this->session->userdata('access') == 1): ?>
							...
							<li class="grey dropdown-modal">
								<a data-toggle="dropdown" class="dropdown-toggle" href="#">
									...
									<span class="badge badge-inverse" id="jmlAngkaTesti"></span>
								</a>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar                  responsive                    ace-save-state">
				...
				<ul class="nav nav-list">
					...
					<li class="<?= (($title == 'Artikel' || $title == 'Tambah Artikel' ||$title == 'Edit Artikel' ||$title == 'Hapus Artikel' ||
					// kategori artikel
					$title == 'Kategori Artikel' || $title == 'Tambah Kategori Artikel' ||$title == 'Edit Kategori Artikel' ||$title == 'Hapus Kategori Artikel' ||
				// label artikel
					$title == 'Label Artikel' || $title == 'Tambah Label Artikel' ||$title == 'Edit Label Artikel' ||$title == 'Hapus Label Artikel') ? 'active open' : ''); ?>">
					...
					<ul class="submenu">
						...
						<li class="<?= (($title == 'Artikel' ||	$title == 'Edit Artikel' ||
						$title == 'Hapus Artikel') ? 'active' : ''); ?>">
			...
			<!-- <li class="<?= (($title == "Agenda" ||$title == "Tambah Agenda" ||$title == "Edit Agenda") ? 'active open' : ''); ?>">
				<a href="#" class="dropdown-toggle">
			...
			<!-- <li class="<?= (($title == "Berita" ||$title == "Tambah Berita" ||$title == "Edit Berita") ? 'active open' : ''); ?>">
				<a href="#" class="dropdown-toggle">
			...
			<?php if($this->session->userdata('access') == 1): ?>
				<!-- <li class="<?= (($title == "Galeri" ||$title == "Album" ||$title == "Tambah Galeri" ||$title == "Edit Galeri") ? 'active open' : ''); ?>">
					<a href="#" class="dropdown-toggle">
				...
				<li class="<?= (($title == 'Banner' || $title == 'Website' || $title == 'Menu' || $title == 'Menu Footer' || $title == 'Konten Kontak' || $title == 'Tambah Konten Kontak' || $title == "Background") ? 'active open' : ''); ?>">
					<a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						...
						<li class="<?= (($title == 'Background' || $title == 'Tambah Background') ? 'active' : ''); ?>">
							<a href="<?= site_url('admin/background') ?>">
								<i class="menu-icon fa fa-picture-o"></i>
								Background Halaman
							</a>
							<b class="arrow"></b>
				...
				<!-- <li class="<?= (($title == 'Kata Sambutan' || $title == 'Fasilitas' || $title == 'Tambah Fasilitas' || $title == 'Edit Fasilitas' || $title == 'Pengaturan Homepege') ? 'active open' : ''); ?>">
					<a href="#" class="dropdown-toggle">
						<i class="menu-icon fa fa-desktop"></i>
					...
					<ul class="submenu">	
						...
						<li class="<?= (($title == 'Pengaturan Homepege') ? 'active' : ''); ?>">
