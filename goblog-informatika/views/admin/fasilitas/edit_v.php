	...
	<form class="form-horizontal" method="POST" action="<?= $form_action ?>" enctype="multipart/form-data" role="form">
		<div class="col-md-8 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" name="nama_fasilitas" id="nama_fasilitas" class="form-control" placeholder="Nama Fasilitas" value="<?= $data->nama_fasilitas ?>">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<textarea class="form-control" rows="5" placeholder="Deskripsi Fasilitas" id="deskripsi_fasilitas" name="deskripsi_fasilitas"><?= $data->deskripsi_fasilitas ?></textarea>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="file" name="filefoto" id="gambar_fasilitas" class="form-control dropify" data-default-file="<?= $src ?>">
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="input-group">
						<span class="input-group-addon"><i class="<?= $data->ikon_fasilitas ?>"></i></span>
						<input type="text" name="ikon_fasilitas" id="ikon_fasilitas" class="form-control" placeholder="fa fa-nama-ikon" value="<?= $data->ikon_fasilitas ?>">
