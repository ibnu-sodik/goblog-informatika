			...
			<div class="widget-header">
				...
				<div class="widget-toolbar no-border">
					<ul class="nav nav-tabs">
						<li class="active">
							<a data-toggle="tab" href="#task-tab" aria-expanded="false">Log Aktivitas Personil</a>
						</li>

						<?php if($userdata == '1'): ?>
							<li class="">
								<a data-toggle="tab" href="#testimoni-tab" aria-expanded="false">
									<span id="jumlahBaru"></span>
									Testimoni Baru
								</a>
							</li>
						<?php endif; ?>
					...
					<div class="tab-content padding-8">
						...
						<?php if($userdata == '1'): ?>
							<div id="testimoni-tab" class="tab-pane">
								<div class="row">
									<div class="table-responsive">
										<table class="table table-hover table-bordered" id="tabeltestimoni" width="100%">
											<thead>
												<tr>
								...
								<div class="center">
									<i class="ace-icon fa fa-rss fa-2x green middle"></i>
									&nbsp;
									<a href="<?= site_url('admin/testimoni') ?>" class="btn btn-sm btn-white btn-info">
...
<script src="<?= base_url('dists/highcharts/highchart.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/highchart-more.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/dumbbell.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/lollipop.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/exporting.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/export-data.js') ?>"></script>
<script src="<?= base_url('dists/highcharts/accessibility.js') ?>"></script>
