				...
				<div class="col-xs-12 col-sm-3 center">
					<div>
						<span class="profile-picture">
							<?php 
							$file_foto = file_exists(base_url('./uploads/personil/'.$foto));
							if (!$file_foto && !empty($foto)) {
								$src = base_url('./uploads/personil/'.$foto);
							}else{
								$src = base_url('dists/images/avatars/avatar.png');
							}
							?>
					...
					<?php if ($jml_artikel > 0): ?>
						<div class="space-6"></div>
						<div class="hr hr12 dotted"></div>
						<div class="clearfix">
							<div class="grid1">
								<span class="bigger-175 blue"><?= $jml_artikel ?></span>
								<br>
								Artikel
							</div>
						</div>						
				...
				<div class="col-xs-12 col-sm-9">
					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<span class="edit"><?= (($personil_info == '') ? 'Belum pernah mengisi.' : $personil_info) ?></span>
								<textarea class="form-control input-sm" name="personil_info" id="personilInfo_<?= $id ?>" style="display: none;"><?= $personil_info ?></textarea>
							</div>
						</div>
					</div>
							...
							<div class="widget-main padding-8">
								<div id="profile-feed-1" class="profile-feed ace-scroll" style="position: relative;">
									...
									<div class="scroll-content">
										<?php 
										foreach ($log_personil->result() as $row):
