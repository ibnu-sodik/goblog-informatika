					...
					foreach ($data_label->result() as $row):
						...
						<tr>
							...
							<td class="text-center">
								...
								<a class="red tombol-hapus" href="<?=site_url('admin/artikel/hapus-label/'.$row->id_label); ?>">
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="modalCategory" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?=site_url('admin/artikel/simpan_label')?>">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="modalCategory" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form method="post" action="<?=site_url('admin/artikel/update_label')?>">
				<div class="modal-body">
					<div class="form-group">
