		...
		foreach ($komentar->result() as $row):
			...
			<div class="timeline-container">
				<div class="timeline-label">
					<a style="text-decoration: none;" href="<?= site_url('artikel/'.$row->slug_artikel) ?>" target="_blank">
								...
								<div class="widget-main">
									...
									<div class="widget-toolbox clearfix">
										...
										<div class="pull-right action-buttons">
											<a data-id_komentar="<?= $row->id_komentar ?>" data-id_komentar_artikel="<?= $row->id_komentar_artikel ?>" data-konten_komentar="<?= $row->konten_komentar ?>" href="javascript:void(0)" title="Balas" class="tombol-balas">
												...
												<div class="widget-body">									
													<div class="widget-main">
														...
														<div class="widget-toolbox clearfix">
															...
															<div class="pull-right action-buttons">
																<a data-id_komentar="<?= $rowBal->id_komentar ?>" data-id_komentar_artikel="<?= $rowBal->id_komentar_artikel ?>" data-konten_komentar="<?= $rowBal->konten_komentar ?>" href="javascript:void(0)" title="Balas" class="tombol-balas">
																	<i class="ace-icon fa fa-reply green bigger-130"></i>
																</a>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('.tombol-balas').on('click', function() {
			...
			$('[name="id_komar_blas"]').val(id_komentar_artikel);
