	...
	<form class="form-horizontal" method="POST" enctype="multipart/form-data" role="form" action="<?= $form_action; ?>">
		<div class="col-md-8 col-xs-12">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="nama_agenda" placeholder="Nama Agenda" name="nama_agenda" class="form-control judul"  value="<?= set_value('nama_agenda') ?>" />
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<div class="input-group">
						<input class="form-control date-picker" id="tgl_pelaksanaan" name="tgl_pelaksanaan" type="text" data-date-format="yyyy-mm-dd" placeholder="Tanggal Pelaksanaan" />
